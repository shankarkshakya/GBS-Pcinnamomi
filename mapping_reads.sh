...
REF="/nfs1/BPP/Grunwald_Lab/home/shakyash/cinnamomi/PCINNA_REF/Pcinna_ref"


#CMD="bowtie2 -x ../../../PCINNA_REF/Pcinna_ref -U ${fq[$i]} --rg-id ${fq[$i]} -S ${fq[$i]}.sam"
#CMD="bowtie2 -x shakyash/cinnamomi/PCINNA_REF/Pcinna_ref -U newtrimmed.fq --rg-id ${fq[$i]} --rg PU:ill --rg SM:${fq[$i]} --rg PL:Illumina -S ${fq[$i]}.sam"
CMD="bowtie2 -x $REF -U ${fq[$i]} --rg-id ${fq[$i]} --rg PU:ill --rg SM:${fq[$i]} --rg PL:Illumina -S ${fq[$i]}.sam"
